...
from app.api.nearest_geolocations.nearest_api import router as nearby_router
...
route.include_router(nearby_router, prefix='/nearby', tags=["NEARBY ADVERTISEMENT"])